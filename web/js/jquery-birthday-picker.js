$(function($) {
	...
	generateBirthdayPicker = function($parent, options) {
		...
		var parentName = $parent.attr('name').replace(/-/g, '');
		var $fieldset, $year, $month, $day, $birthday;
		// Create the html picker skeleton
		$fieldset      = $("<fieldset class='birthdayPicker'></fieldset>");
		console.log(options);
		if(options.required) {
			$year  = $("<select class='birthYear " + options.sizeClass + "' required name='" + parentId + "_birth[year]'></select>");
			$month = $("<select class='birthMonth " + options.sizeClass + "' required name='" + parentId + "_birth[month]'></select>");
			$day   = $("<select class='birthDate " + options.sizeClass + "' required name='" + parentId + "_birth[day]'></select>");
		} else {
		...
		$birthday = $("<input class='birthDay' name='" + parentName + "' type='hidden'/>");
